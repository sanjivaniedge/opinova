      ...
      <div>
        ...
        <div className="mx-auto mt-10 max-w-6xl px-6 ">
          <div className="relative rounded-2xl  pb-[88px] overflow-hidden ">
            <Image src="/images/banner1.webp" alt="Chalkboard" width={1200} height={700} className="lg:h-[650px] w-full rounded-2xl" />
            {/* floating stats */}
            <div className="absolute z-20 pb-10 md:bottom-18 font-bold bottom-14 left-1/2 flex -translate-x-1/2 translate-y-1/2 md:gap-6 gap-2 ">
              {[
                { value: "1000+", label: "people provided with\n health care support", color: "text-accent" },
                { value: "200+", label: "hours of student\nprototype mentorship", color: "text-[#64C58B]" },
                { value: "100+", label: "rural families\ntrained for mirco-employment", color: "text-[#F0A74A]" },
              ].map((s) => (
                <div
                  key={s.value}
